...
section_class.prototype.init_buttons = function() {
    ...
    if (main.getString('courseformat', this.sectionId) != "weeks" && this.sectionId > 0) {
        var highlightbutton = main.mk_button('a', main.portal.icons['marker'], main.getString('marker', this.sectionId));
    ...
    if (this.sectionId > 0) {
        var viewbutton = main.mk_button('a', main.portal.icons['hide'], main.getString('hidesection', this.sectionId),
